...
$result = $conn->query("SELECT sno, lastname, firstname, houseNumber, status  FROM tbl_user WHERE status='Active' ORDER BY firstname, lastname");
...
<script>
    function editAdmin(id) {
        window.location.href = `update_patient.php?sno=${id}`;
    }
    </script>
